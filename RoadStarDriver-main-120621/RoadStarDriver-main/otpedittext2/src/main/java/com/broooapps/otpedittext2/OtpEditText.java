...
public class OtpEditText extends AppCompatEditText implements TextWatcher {
    ...
    private OnCompleteListenerOtp completeListener;
    ...
    public void afterTextChanged(Editable s) {
        if (s.length() == mNumChars) {
            completeListener.onCompleteOtp(String.valueOf(s));
        }
    }
    ...
    public void setOnCompleteListener(OnCompleteListenerOtp listener) {
