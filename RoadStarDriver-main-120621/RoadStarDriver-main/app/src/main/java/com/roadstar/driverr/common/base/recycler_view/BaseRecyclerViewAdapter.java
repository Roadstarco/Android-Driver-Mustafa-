...
import com.roadstar.driverr.app.data.models.Empty;
import com.roadstar.driverr.app.data.models.Header;
...
abstract public class BaseRecyclerViewAdapter extends RecyclerView.Adapter<BaseRecyclerViewHolder> implements View.OnClickListener {
     ...
     */
    private com.roadstar.driverr.common.base.recycler_view.OnRecyclerViewItemClickListener itemClickListener = null;

    public BaseRecyclerViewAdapter(List<BaseItem> items, com.roadstar.driverr.common.base.recycler_view.OnRecyclerViewItemClickListener itemClickListener) {
        this.items = items;
