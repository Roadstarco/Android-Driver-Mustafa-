package com.roadstar.driverr.common.base;
...
import com.roadstar.driverr.app.business.OnContentChangeListener;
import com.roadstar.driverr.app.business.OnNetworkTaskListener;
...
import com.roadstar.driverr.app.network.AppNetworkTask;
...
import com.roadstar.driverr.common.utils.BadgeDrawable;
import com.roadstar.driverr.common.utils.BorderErrorEditText;
import com.roadstar.driverr.common.utils.Logger;
import com.roadstar.driverr.common.utils.NetworkUtils;
import com.roadstar.driverr.common.utils.SharedHelper;
import com.roadstar.driverr.common.utils.ViewUtils;
import com.roadstar.driverr.common.views.CustomSnackBar;
...
import static com.roadstar.driverr.common.utils.AppConstants.REQUEST_STORAGE_READ_WRITE_ACCESS_PERMISSION;
...
abstract public class BaseActivity extends AppCompatActivity implements OnContentChangeListener, OnNetworkTaskListener {
    ...
    public UserProfileResp profileResp ;
    ...
    public void setOnlineStatus(){
        SwitchCompat onlineStatus = findSwitchByID(R.id.online_status_switch);
        onlineStatus.setChecked(SharedHelper.getBoolean(this,"online"));

        onlineStatus.setVisibility(View.VISIBLE);
        onlineStatus.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ChangedStatus(onlineStatus,isChecked);
            }});
    }

    private void ChangedStatus(SwitchCompat switchCompat,boolean changedState) {

        StatusChangeModel body = new StatusChangeModel();
        if (changedState)
            body.setService_status("active");
        else
            body.setService_status("offline");

        ApiInterface mApiInterface = RetrofitClient.getRetrofitClient().create(ApiInterface.class);
        Call<ResponseBody> call = mApiInterface.changeOnlineStatus(body);
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(@NonNull Call<ResponseBody> call, @NonNull retrofit2.Response<ResponseBody> response) {
                ...
                if (response.code() == 200) {
                    ...
                    SharedHelper.putBoolean(BaseActivity.this,"online",changedState);
    ...
    public void setHeaderData() {
        if (profileResp != null){
            ...
            findTextViewById(R.id.tv_user_name).setText(profileResp.getFirst_name() + " " + profileResp.getLast_name());
            findTextViewById(R.id.tv_email).setText(profileResp.getEmail());

            if (profileResp.getAvatar() != null )
                findVizImageView(R.id.iv_user_image).setImage(profileResp.getAvatar());
    ...
    private void performCrop(Uri picUri) {
        try {
            ...
            this.startActivityForResult(cropIntent, CROP_IMAGE_ACTIVITY_REQUEST_CODE);
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, final Intent data) {
        ...
        if (requestCode == PICK_IMAGE_CHOOSER_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
            Uri imageUri = CropImage.getPickImageResultUri(BaseActivity.this, data);
