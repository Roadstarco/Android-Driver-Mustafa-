...
import com.roadstar.driverr.app.network.HttpRequestItem;
...
import static com.roadstar.driverr.common.utils.ApiConstants.KEY_CONFIRM_PASS;
import static com.roadstar.driverr.common.utils.ApiConstants.KEY_ID;
import static com.roadstar.driverr.common.utils.ApiConstants.KEY_PASSWORD;
import static com.roadstar.driverr.common.utils.ApiConstants.RESET_PASSWORD_URL;
import static com.roadstar.driverr.common.utils.DataManager.FORGET_PASSWORD_URL;
import static com.roadstar.driverr.common.utils.DataManager.KEY_EMAIL;
import static com.roadstar.driverr.common.utils.DataManager.KEY_ERROR;
...
public class ForgetPasswordActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void callResetPassword() {
        ...
        requestItem.setHeaderParams(AppUtils.getHeaderParamsForReset());
        ...
        try {
            ...
            if (response.getHttpRequestEndPoint().equals(FORGET_PASSWORD_URL)) {
                ...
                if (apiResponse.has(KEY_ERROR)) {
                    ...
                    JSONObject user = apiResponse.optJSONObject("provider");
