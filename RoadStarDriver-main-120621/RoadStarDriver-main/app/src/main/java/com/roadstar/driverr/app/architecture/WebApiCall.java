package com.roadstar.driverr.app.architecture;
...
//        requestItem.setHeaderParams(AppUtils.getHeaderParams());    // Add header params (Cookies)
         ...
         *  {@link com.roadstar.driverr.common.base.BaseActivity#getProgressDialog(boolean)}
         *  2) {@link com.roadstar.driverr.app.business.OnNetworkTaskListener}
